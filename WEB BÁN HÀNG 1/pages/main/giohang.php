...
?>	
<table style="width:100%;text_align: center;border-collapse:collapse;" border="1">
  <tr>
    <th>Id</th>
    <th>Mã sp</th>
    <th>Tên sản phẩm</th>
  ...
  <tr>
    ...
    <td>
    	...
    	<a href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><i class="fa-sharp fa-solid fa-minus"></i></a>	
